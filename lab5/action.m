function action()
  num                         = 20;
  [A b]                       = generate_equation(26,15);
  start_x                     = ones(7,1);

  % Iterative method
  [iter_solution iter_conv iter_plot]   = iter_method(A,b,start_x,num);
  ...
  % Seidel method
  [seidel_solution seidel_conv seidel_plot]   = seidel_method(A,b,start_x,num);
  ...
  % Output iter values
  iter_residual, iter_conv, iter_norm_residual

  % Output seidel values
  seidel_residual, seidel_conv, seidel_norm_residual
